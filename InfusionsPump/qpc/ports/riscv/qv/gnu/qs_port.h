...
#endif // Kan vara så att vi vill använda "#include "qp_port.h" " för att används QS med QP

//#include "qs.h"      // QS platform-independent public interface

//-------------------------------Tillagt för portning av QSPY---------------------------------
#ifdef Q_SPY
    #define QS_MEM_SYS(m_)  m_ 
    #define QS_MEM_APP(m_)  m_
#endif
//-----------------------------------------------------------------------------
